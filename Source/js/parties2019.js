var getParties = function () {
  ...
  var likud = new party("ליכוד", 1135255);
  var kacholavan = new party("כחול לבן", 1119955);
  var shas = new party("שס", 257359);
  var yahadut = new party("יהדות התורה", 247692);
  var chadash = new party("חדש-תעל", 192027);
  var avoda = new party("עבודה", 191839);
  var betenu = new party("ישראל ביתנו", 172578);
  var bait = new party("איחוד מפלגות הימין", 159096);
  var meretz = new party("מרצ", 155543);
  var cachlon = new party("כולנו", 152084);
  var raam = new party("רעם-בלד", 142959);
  var yaminchadash = new party("הימין החדש", 138103);
  var zehut = new party("זהות", 117399);
  var gesher = new party("גשר", 74220);
  var betach = new party("בטח", 4717);
  var aravit = new party("הרשימה הערבית", 4228);
  var tzedek = new party("צדק חברתי", 3828);
  var magen = new party("מגן", 3432);
  var tzedeklakol = new party("צדק לכל", 3271);
  var tzomet = new party("צומת", 2426);
  var zchuyot = new party("זכויותינו בקולנו", 1505);
  var yashar = new party("ישר", 1434);
  var vatikim = new party("האזרחים הותיקים", 1185);
  var achim = new party("כל ישראל אחים", 1133);
  ...
  var shavim = new party("שווים", 399);
